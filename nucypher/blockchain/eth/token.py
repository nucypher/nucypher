...
class Stake:
    ...
    def __init__(self,
        ...
        self.staker = staker
        owner_address = staker.checksum_public_address
    ...
    def __deposit(cls, staker, amount: int, lock_periods: int) -> Tuple[str, str]:
        ...
        approve_txhash = staker.token_agent.approve_transfer(amount=amount,
                                                            ...
                                                            sender_address=staker.checksum_public_address)
    ...
    def initialize_stake(cls, staker, amount: NU, lock_periods: int = None) -> 'Stake':
        ...
        log = Logger(f'stake-{staker.checksum_public_address}-creation')
        log.info("{} Initialized new stake: {} tokens for {} periods".format(staker.checksum_public_address,
                                                                             amount,
                                                                             lock_periods))
        return stake
