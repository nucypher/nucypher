...
class MoeBlockchainCrawler:
    ...
    def _learn_about_contracts(self):
        ...
        token_counter = {day: NU.from_nunits(self._moe.staking_agent.get_all_locked_tokens(day)).to_tokens()
    ...
    def get_db_client(self):
        return InfluxCrawlerClient(host='localhost', port=8086, database=self.DB_NAME)
