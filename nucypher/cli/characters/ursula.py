...
@click.option('--rest-host', help="The host IP staker_address to run Ursula network services on", type=click.STRING)
...
@click.option('--worker-address', help="Run the worker-ursula with a specified staker_address", type=EIP55_CHECKSUM_ADDRESS)
@click.option('--federated-only', '-F', help="Connect only to federated nodes", is_flag=True, default=None)
