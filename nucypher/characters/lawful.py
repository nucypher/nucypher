...
class Bob(Character):
    ...
    def __decrypt(
        ...
        cleartext = decrypt_with_shared_secret(
            ciphertext, conditions, shared_secret, params  # aad  # dkg params
        )
        return cleartext

    @staticmethod
    def __derive_dkg_parameters(
        ritual_id: int, ursulas, ritual, threshold
    ) -> DkgPublicParameters:
        ...
        pvss_aggregated, public_key, params = aggregate_transcripts(
            ...
            me=validators[
                0
            ],  # TODO: #3097 this is awkward, but we need to pass "me" here to derive_generator_inverse
            threshold=threshold,
