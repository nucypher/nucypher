...
she uses TACo's proxy re-encryption (PRE) on the TACo Network to create a _policy public key_ for the Heart Monitor to use,
...
Once she obtains her Doctor's public keys, she can create a policy in the TACo Application on the TACo Network granting access to him.
...
This simple use case showcases many interesting and distinctive aspects of TACo:
  ...
  - Alicia only interacts with the TACo Network for granting access to the Doctor.
...
TACo Network . The result is printed in the console:
