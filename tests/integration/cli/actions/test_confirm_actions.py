...
from nucypher.blockchain.eth.constants import PUBLIC_CHAINS
...
def test_confirm_deployment_cli_action(mocker, mock_stdin, test_emitter, capsys, mock_testerchain):
    ...
    mocker.patch.dict(PUBLIC_CHAINS, {llamanet_chain_id: 'llamanet'})

    mocker.patch.object(MockEthereumClient,
                        'chain_id',
