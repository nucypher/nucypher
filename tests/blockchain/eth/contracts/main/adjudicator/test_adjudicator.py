...
def test_evaluate_cfrag(testerchain,
    ...
    def compute_penalty_and_reward(stake: int, penalty_history: int) -> Tuple[int, int]:
        penalty_ = test_economics.base_penalty
        penalty_ += test_economics.penalty_history_coefficient * penalty_history
        penalty_ = min(penalty_, stake // test_economics.percentage_penalty_coefficient)
        reward_ = penalty_ // test_economics.reward_coefficient
    ...
    assert penalty == previous_penalty + test_economics.penalty_history_coefficient
    worker_stake -= penalty
    investigator_balance += reward
    worker_penalty_history += 1
    ...
    assert penalty == worker_stake // test_economics.percentage_penalty_coefficient
    worker_stake -= penalty
    investigator_balance += reward
    worker_penalty_history += 1
