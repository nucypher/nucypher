...
def test_rewards_ratios_after_increase(testerchain, agency, token_economics, test_registry):
    ...
    for config in configs:
        _prepare_staker(origin_tpower, staking_agent, token_agent, token_economics, config[0], config[1], config[2])
...
def _commit_to_next_period(staking_agent, ursulas_tpowers):
