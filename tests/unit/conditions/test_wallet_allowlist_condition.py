...
def test_wallet_allowlist_condition_verify():
    ...
    context = {
        "userAddress": allowed_account1.address
    }
    ...
    context = {
        "userAddress": not_allowed_account.address
    }
    ...
    context = {
        "userAddress": allowed_account2.address
    }
...
def test_wallet_allowlist_condition_serialization():
    ...
    # Create condition
    addresses = [account1.address, account2.address]
    original_condition = WalletAllowlistCondition(addresses=addresses, name="Test Condition")
